...
centroid_x, centroid_y, centroid_name = df_centroids(df_grouped)
...
y_pred_index_all, y_pred_name_all = [], []
for fake_point in fakeresult:
    ...
    y_pred_name_all.append(df_centroids.iloc[np.argmin(distances)]["centroid_name"])
...
print ("labels ==================== ", labels)
conf_mat = confusion_matrix(y_true_name, y_pred_name_all, labels=labels) # TODO: konnte sein dass diese Zeile falsch .. bitte kontrolieren
print ("conf_mat ==================== ", conf_mat)
class_report = classification_report(y_true_name,y_true_name)
print ("class_report ==================== ", class_report)
print ("confusion_matrix(y_true_name, y_true_name) ==================== ", confusion_matrix(y_true_name, y_true_name))
