...
def plot_all_points(
    Dx, finalDf, y_true_name, fakeresult, class_index,output_dir_name,
):
    ...
    plt.savefig(output_dir_name + "/plot/" + "PCA_all/all_points_%s.png" % (str(class_index)))
    # plt.show()
...
def plot_centroids_and_points(
    all_centroids, df_centroids, y_true_name, y_pred, class_index, y_centroid=None,output_dir_name="",
):
    ...
    plt.savefig(output_dir_name + "/plot/" + "PCA_centroids/all_centroids_%s.png" % (str(class_index)))
    # plt.show()
...
def main():
    ...
    for exp in range(36):
        ...
        os.makedirs(output_dir_name + "/" + "csv/", exist_ok=True)
        os.makedirs(output_dir_name + "/" + "plot/", exist_ok=True)
        os.makedirs(output_dir_name + "/" + "plot/PCA_centroids/", exist_ok=True)
        os.makedirs(output_dir_name + "/" + "plot/PCA_all/", exist_ok=True)
        #PCA_centroids PCA_all
        ...
        for class_index in range(39):
            ...
            fake = pd.read_csv(output_dir_name +"/"+ file_name, sep=";", header=None)  # TODO: HIER AUS ÄNDERN
            ...
            plot_all_points(Dx, finalDf, y_true_name, fakeresult, class_index, output_dir_name)
            ...
            plot_centroids_and_points(
                ...
                y_pred,
                # y_centroid,
                class_index,output_dir_name=output_dir_name,
            )
        ...
        df_all_end_results.to_csv(output_dir_name + "/csv/" + "df_all_end_results.csv", sep=";", index=False)

        df_summary.to_csv(output_dir_name + "/csv/" + "df_summary_evaluation.csv", sep=";", index=False)
