...
ap.add_argument(
    ...
    type=str,
    # default="/home/amath/Desktop/Plate2/data",
    help="list of all neurons in all num_of_layers",
)
ap.add_argument(
    "-output_dir_name",
    "--output_dir_name",
...
list_of_layers = args["list_of_layers"]
output_dir_name = args["output_dir_name"]
num_of_batch = int(args["num_of_batch"])

list_of_layers = ast.literal_eval(list_of_layers)
os.makedirs(output_dir_name, exist_ok=True)

print (list_of_layers)
print (type(list_of_layers))
###################################
...
def define_discriminator(in_shape=(976,1), n_classes=39):
    ...
    for i in range(int(num_of_layers)):
        ...
        fe=(Dense(list_of_layers[i], activation="sigmoid"))(fe)
    # real/fake output
...
model.summary()
#modelCV = KerasClassifier(build_fn=define_discriminator, verbose=0)

#param_grid={"hidden_layers": [3]}
...
# train model
train(generator, discriminator, gan_model, dataset, latent_dim, n_batch=num_of_batch)
